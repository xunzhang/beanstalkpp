/**
 * Cluster Extension for Beanstalkpp, using tubeHash
 * Authors: Hong Wu <xunzhangthu@gmail.com>
 *
 */

#ifndef _BEANSTALK_HASHPOOL_H
#define _BEANSTALK_HASHPOOL_H
...
class hPool {
 ...
 public:
  ...
  hPool(std::vector<std::string> serversInfo) {
